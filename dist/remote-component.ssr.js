...
var RemoteComponent = RemoteComponent_1 = /*#__PURE__*/function (_Vue) {
  _inherits(RemoteComponent, _Vue);

  var _super = _createSuper(RemoteComponent);
  ...
  _createClass(RemoteComponent, [{
    ...
    value: function () {
      ...
      function onUrlChanged() {
        return _onUrlChanged.apply(this, arguments);
      }
    ...
    get: function get() {
      ...
      var library = (_this$url = this.url) === null || _this$url === void 0 ? void 0 : (_this$url$split = _this$url.split("/")) === null || _this$url$split === void 0 ? void 0 : (_this$url$split$rever = _this$url$split.reverse()[0]) === null || _this$url$split$rever === void 0 ? void 0 : _this$url$split$rever.match(/^(.*?)\.umd/);

      if (library == null) {
        throw new Error("".concat(this.url, " could not be parsed as a path pointing to an UMD module. Please provide an explicit module name."));
      }
...
var script = RemoteComponent;function normalizeComponent(template, style, script, scopeId, isFunctionalTemplate, moduleIdentifier /* server only */, shadowMode, createInjector, createInjectorSSR, createInjectorShadow) {
...
}, __vue_inject_styles__, __vue_script__, __vue_scope_id__, __vue_is_functional_template__, __vue_module_identifier__, false, undefined, undefined, undefined);exports.default=__vue_component__;//# sourceMappingURL=remote-component.ssr.js.map
